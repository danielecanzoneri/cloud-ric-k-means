...
public class Util {
    ...
    public static String chooseCentroids(String datasetFile, int numCentroids) {
        ...
        try {
            ...
            if (fs.exists(datasetPath)) {
                ...
                // Avoid to compute the size of the dataset multiple times
                if (datasetSize == -1) {
    ...
    public static String readCentroids(String centroidsFile) {
        StringBuilder centroids = new StringBuilder();
